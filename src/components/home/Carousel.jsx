          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/30 flex justify-center items-center text-center px-4">
                <div className="bg-white/40 backdrop-blur-md p-6 md:p-10 rounded-3xl text-purple-900 w-5xl shadow-lg z-10">
                  ...
                  {slide.button && slide.link && (
                    <Link
                      to={slide.link}
                      className="bg-white text-purple-700 py-2 px-6 rounded-full text-lg font-medium hover-button-animation"
                    >
                      {slide.button}
                    </Link>
                  )}
