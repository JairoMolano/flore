    ...
    <div>
      <div className="mt-25 max-w-5xl mx-auto flex flex-row items-center">
        ...
        <div className="w-1/2 text-center text-left pl-8">
          <h1 className="text-4xl font-bold mb-6">Domicilios</h1>
      ...
      <div className="flex justify-center my-8">
        <button className="px-6 py-3 bg-blue-500 text-white font-bold rounded hover:bg-blue-600 cursor-pointer transition duration-200">
          Ordenar Ahora
        </button>
      </div>
    </div>
