    ...
    <>
      <div className="flex flex-col items-center justify-center w-full max-w-5xl mx-auto text-center py-8 mt-25">
        ...
        <label
          ...
          className="btn px-6 py-3 bg-[#9C7696] border-[#9C7696] text-white font-bold hover-button-animation cursor-pointer"
        >
      ...
      <div className="modal bg-gray-200 bg-opacity-90">
        <div className="modal-box bg-gray-100">
          ...
          <div className="modal-action">
            <button
              type="button"
              className="btn bg-[#9C7696] border-[#9C7696] text-white hover:bg-[#8a5c84]"
            ...
            <label
              htmlFor="reserve-modal"
              className="btn bg-gray-300 text-black hover:bg-gray-400 cursor-pointer"
            >
              Cancelar
            </label>
          </div>
