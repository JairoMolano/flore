  ...
  return (
    ...
    <div className="text-center mt-25 mx-auto max-w-5xl">
      ...
      <h3 className="text-lg font-medium text-gray-700 leading-relaxed">
        ...
        amor por la gastronomía, decidimos abrir un espacio que mezclara lo mejor del
        desayuno y el almuerzo, con ese toque dulce y salado que tanto nos gusta.
        <br />
        En el corazón de Neiva, abrimos las puertas de este rincón que hoy muchos llaman su
        lugar favorito para empezar el día con sabor, alegría y calidez.
      </h3>
    </div>
    </>
  )
